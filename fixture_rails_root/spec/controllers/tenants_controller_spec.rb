  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved tenant as @tenant" do
        ...
        post :create, {:tenant => { "name" => "invalid value" }}, valid_session
        assigns(:tenant).should be_a_new(Tenant)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested tenant" do
        ...
        Tenant.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => tenant.to_param, :tenant => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the tenant as @tenant" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Tenant.any_instance.stub(:save).and_return(false)
        put :update, {:id => tenant.to_param, :tenant => { "name" => "invalid value" }}, valid_session
        assigns(:tenant).should eq(tenant)
      end
